...
def test_default_and_unassigned_queries_send_exclude_hidden(monkeypatch):
    # _setActiveProjectFilter was removed with the "All" project chip (its
    # only caller) -- _activeProject is still read by _sessionListQueryString,
    # just no longer set through that wrapper, so this sets it directly.
