...
def test_read_only_sessions_can_still_open_actions_for_copy_link():
    ...
    # Read-only sessions still get a usable menu: Copy link + the export
    # actions (Markdown/JSON/Text/HTML, all non-mutating -- see
    # docs/HERMES_STUDIO_PARITY_PLAN.md "Chat export") are offered, then the
    # menu mounts and returns early before any mutating action is appended.
