...
- [`agent-canvas-visualization.md`](agent-canvas-visualization.md) —
  implemented live node-graph visualization of `delegate_task` subagent
  activity, SSE event feed, and vendored d3-force + Canvas2D rendering
  approach.
